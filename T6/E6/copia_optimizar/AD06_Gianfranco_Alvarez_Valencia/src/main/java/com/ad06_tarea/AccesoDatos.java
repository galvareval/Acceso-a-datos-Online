...
public class AccesoDatos {
    ...
    //relsut y  para solo ejecutar una vez la obtención de los datos de las listas completas de los 3 campos
    private static ResourceSet result = null;
    //private static ResourceIterator i = null;
    ...
    public static void abrirConexion() {
        ...
        try {
            ...
            //obtener el result sobre el que se sacaran todas las listas completas, 
            if (result == null)//cargar la primera veez que se conecta a la bbd
            {
                XPathQueryService xpqs = (XPathQueryService) col.getService("XPathQueryService", "1.0");
                result = xpqs.query("/playas/playa");//.xml y el nivel
                System.out.println("ejecutada query");
    ...
    public static String buscarComunidad(String provincia) {
        ...
        try {
            ...
            resultBusquedaUno = xpqs.query("for $comunidad in(/playas/playa)\n" +
                                            "where $comunidad/Provincia=\"Lugo\"\n" +
